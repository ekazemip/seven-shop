...
def request_otp(phone_number):
    ...
    if active_code:
        return {"latest_code": active_code, "new_code": None, "success": False}
    ...
    OTPCode.objects.create(
        phone_number=phone_number, code=new_code, expires_at=expires_at
    )
    return {
        "latest_code": None,
        "new_code": new_code,
...
def verify_otp(phone_number, code):
    ...
    try:
        otp = OTPCode.objects.get(phone_number=phone_number, is_used=False)
